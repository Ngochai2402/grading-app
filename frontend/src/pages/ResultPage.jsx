                  ...
                  {cau.cham_tung_dong.map((dong, j) => {
                    ...
                    return (
                      <tr key={j} style={{ background: bg, borderTop: j > 0 ? "1px solid var(--border)" : "none" }}>
                        ...
                        {/* Ghi chú — chỉ hiện khi có nội dung */}
                        <td style={{ padding: "9px 14px", fontSize: 13, lineHeight: 1.7, color: isSai ? "#b71c1c" : "var(--text2)", verticalAlign: "top", wordBreak: "break-word" }}>
                          {dong.ghi_chu ? <MathText text={dong.ghi_chu} /> : null}
                        </td>
                      </tr>
                    );
                  })}
